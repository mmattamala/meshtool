...
try:
    ...
    warn("load_collada", e)
try:
    import meshtool.filters.load_filters.load_obj
except ImportError as e:
    warn("load_obj", e)
...
try:
    ...
    warn("print_render_info", e)
try:
    import meshtool.filters.print_filters.print_bounds
except ImportError as e:
    warn("print_bounds", e)
try:
    import meshtool.filters.print_filters.print_pm_perceptual_error
except ImportError as e:
    warn("print_pm_perceptual_error", e)
...
try:
    ...
    warn("sander_simplify", e)
try:
    import meshtool.filters.simplify_filters.add_back_pm
except ImportError as e:
    warn("add_back_pm", e)
...
try:
    ...
    warn("save_obj_zip", e)
try:
    import meshtool.filters.save_filters.save_bam
except ImportError as e:
    warn("save_bam", e)
try:
    import meshtool.filters.save_filters.save_threejs_scene
except ImportError as e:
    warn("save_threejs_scene", e)
