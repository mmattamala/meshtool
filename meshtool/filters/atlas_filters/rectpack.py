...
class RectPack:
    ...
    def pack(self):
        ...
        rects = [(key, self.rectangles[key][0], self.rectangles[key][1]) for key in self.rectangles]
        rects.sort(rectcmp)
        ...
        while not done:
            ...
            if (
                len(rejects) == 0
                or self.maxwidth
                and width >= self.maxwidth
                and self.maxheight
                and height >= self.maxheight
            ):
                done = True
    ...
    def _insert(self, rootnode, rect):
        ...
        while len(toconsider) > 0:
            ...
            if insert_x + insert_width > this_x + this_width or insert_y + insert_height > this_y + this_height:
            ...
            bottomrect = (
                this_x,
                insert_y + insert_height,
                this_width,
                this_height - insert_height - (insert_y - this_y),
            )
