...
class ThreeJSDictGenerator(object):
    ...
    def toDict(self):
        outdict = {}
        outdict["metadata"] = {"formatVersion": 3, "type": "scene"}
        ...
        outdict["textures"] = dict((cimg.id, {"url": outname}) for cimg, outname in texture_placements.items())
    ...
    def getMaterials(self):
        ...
        for material in self.mesh.materials:
            ...
            color_mapping = [("diffuse", "color"), ("ambient", "ambient"), ("specular", "specular")]
            ...
            float_mapping = [("shininess", "shininess"), ("transparency", "opacity")]
...
def FilterGenerator():
    class ThreeJsSceneSaveFilter(SaveFilter):
        def __init__(self):
            super(ThreeJsSceneSaveFilter, self).__init__(
                "save_threejs_scene", "Saves a collada model in three.js scene format"
            )
